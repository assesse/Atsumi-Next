import jpFlag from "../assets/flags/classic-runtime/jp.png";
import krFlag from "../assets/flags/classic-runtime/kr.png";
import usFlag from "../assets/flags/classic-runtime/us.png";
...
export const languagePresentation: Record<Language, LanguagePresentation> = {
  ...
  chinese: { label: "중국어", icon: null, fallback: null },
