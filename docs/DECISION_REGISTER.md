...
| D-137 | 작품 중복 검사는 verified local artifact와 versioned HashProfile만 사용한다. 정규화된 전체 작가 목록이 겹치는 pair만 생성하며 실제 SHA/perceptual/sequence evidence 없이 강한 후보를 만들지 않는다. | 2026-08-16 Milestone E 구현, 2026-08-25 same-artist bound |
